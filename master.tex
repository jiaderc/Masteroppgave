...
\begin{figure}
	...
	\begin{subfigure}[b]{0.22\textwidth}
		...
		\label{fig:LAURON}
	\end{subfigure}
	\caption[Different types of legged robot]{Overview of different types of legged robot: monopod \ref{fig:onlegg},  biped \ref{fig:nao}, quadruped \ref{fig:bigDog}, and hexapod \ref{fig:LAURON}. }
	\label{fig:robots}
\end{figure}
...
\begin{figure} [h]
	...
	\end{subfigure}
	\caption[Sensor data from each terrain]{Example of sensor data from each terrain: floor \ref{fig:gulvgraf}, carpet \ref{fig:teppegraf}, soft mat \ref{fig:mykmattegraf}, and hard mat \ref{fig:mattebgraf}.}
	\label{fig:gtmgraf}
\end{figure}
\FloatBarrier
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{@{}llll@{}}
			...
			\multicolumn{1}{l|}{} & \multicolumn{1}{l|}{\multirow{-2}{*}{Naive Bayes}} & \multicolumn{1}{l|}{\multirow{-2}{*}{{\color[HTML]{F8A102} 83\%}}} & \multirow{-2}{*}{{\color[HTML]{F8A102} 83\%}} \\ \cmidrule(l){2-4} 
...
\begin{figure}[h]
	...
	\begin{tikzpicture}[scale=0.7,transform shape]
		...
		\caption[Evaluation process with feature selection]{Modified evaluation process from section \ref{subsec:learningProc}, where the new function is feature selection and is colored red.} 
		\label{fig:approach2}
	\end{figure}
\FloatBarrier
\newpage
