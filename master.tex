...
The first process shown in \ref{fig:createsamples} is to gather data for each terrain which will be stored into files. Those files will further be collected into a single file and used as the training and test samples in the next process. 
