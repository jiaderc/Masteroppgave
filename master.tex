...
\begin{document}
	...
	\frontmatter{}
R\chapter*{Abstract}                   %% ... or Sammendrag or Samandrag
...
\subsubsection{SVM - Wrapper - Feature set three} \label{sb:svmwrapper}
...
\subsubsection{Decision Tree - RFLV - Feature set one}
