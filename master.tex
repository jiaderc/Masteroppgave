...
\\
\\
Terrain classification with other type of remote sensor research of can be found in \cite{Giguere2009,6386243,6569179,6569179,4399500}
...
Mostly supervised but there are also some unsupervised 
 
\subsection{Features}
As mentioned in section \ref{features} finding good features is a crucial part of classification process. Earlier work has extracted features either in the time domain, frequency domain or both.
\\
\\
...
\subsection{Summary}
It can be seen that the SVM still got the higestest accurate. This can be that the feature selection plays an important rule. While the neural network got a worse. The soft mast is least confused cause of its characterstics. A common terrain that each classifier has difficulty to predict is the hard mat. It has either achieved a high precision, but low recall or vice versa. It is seen that it rather predict the carpet when it is on hard mat.  
\\
\\
