...
Reading from the sensor is set to default, 100Hz and filtering frequency, as a string to 15Hz. A stable gait is used to walk 10 step on each terrains. The runs were recorded into rosbag, which make it possible re-simulate the run. Each step represent a sample, and in total was 50 samples collected from each of terrains.
