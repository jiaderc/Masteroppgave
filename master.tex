...
As new and improvement sensors are constantly developed, data provided from sensor are more able to discriminate different terrains. This thesis investigates the possibility of identifying different terrains using optical force sensors and machine learning.
...
- goals: (forslag)
main goal : Investigate if it is possible to distinguish between different surfaces using optical force sensors and machine learning
subgoal: develop/investigate a reliable approach for data preprocessing, feature selection, and classification. 
Andre subspørsmål som kanskje er interessante, men kommer an på hvor mye det diskuteres:
- How quickly can transitions between terrains be detected
- Is the method suitable for real-time / real-world implementation
