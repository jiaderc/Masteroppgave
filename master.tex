...
\subsection{Analysis}
Tuning parameter did not give a significant effect of the performance. Mostly is slightly decreased, but neural network with two outputs has minor increased. Again, the best performed classifier is SVM with feature set 3. 
\\
\\
