...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{@{}llll@{}}
			...
			\multicolumn{1}{l|}{\multirow{-5}{*}{\begin{tabular}[c]{@{}l@{}}Set two - \\ statistical features in \\ time domain\end{tabular}}} & \multicolumn{1}{l|}{SVM} & \multicolumn{1}{l|}{0.76} & {\color[HTML]{F8A102} 0.85} \\ \midrule
			...
			\multicolumn{1}{l|}{\multirow{-5}{*}{\begin{tabular}[c]{@{}l@{}}Set three - \\ complete frequency \\ domain\end{tabular}}} & \multicolumn{1}{l|}{SVM} & \multicolumn{1}{l|}{0.52} & {\color[HTML]{009901} 0.93} \\ \midrule
			...
			\multicolumn{1}{l|}{} & \multicolumn{1}{l|}{Bayes Navies} & \multicolumn{1}{l|}{{\color[HTML]{F8A102} 0.82}} & {\color[HTML]{F8A102} 0.82} \\ \cmidrule(l){2-4} 
			\multicolumn{1}{l|}{} & \multicolumn{1}{l|}{Decision tree} & \multicolumn{1}{l|}{0.79} & {\color[HTML]{F8A102} 0.80} \\ \cmidrule(l){2-4} 
			\multicolumn{1}{l|}{} & \multicolumn{1}{l|}{KNN} & \multicolumn{1}{l|}{{\color[HTML]{F8A102} 0.88}} & {\color[HTML]{F8A102} 0.84} \\ \cmidrule(l){2-4} 
	...
	\caption{Table showing the result after following the approach shown in figure \ref{fig:learningProcess}. Colored green has an accuracy over 90\%, yellow is between 80\%-89\%, while black has accuracy under 79\%}
	\label{exp1}
\end{table}
\FloatBarrier
...
\begin{table}[h]
	...
	\end{tabular}
	\caption{Table shows the Pythons kernels.}
	\label{aptab:kern}
\end{table}
\FloatBarrier
