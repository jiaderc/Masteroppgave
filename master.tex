...
\begin{document}
	...
	The aim of this thesis was to investigate the possibility of terrain classification using a 3D optical force sensor. The approach was machine learning on force data provided from the sensor mounted on a quadruped robot. The quality of sensor was based on selecting the best of five classifiers and five feature sets. Four different terrains were used during the experiments, floor, carpet, hard mat, soft mat.
	\\
	\\
	Results show that there is possibility of distinguish between terrain with slightly difference in their properties. A combination of SVM and selected features from frequency domain with wrapper method, gives an accuracy over 90\% on unseen data.   
