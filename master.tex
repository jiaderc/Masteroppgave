...
\begin{figure}[h]
	...
	\caption[Transforming the data into a linearly separable space]{Transformation of the data from non linearly separable to linearly separable space \cite{Marsland:2009:MLA:1571643}.}
...
\begin{table}[h]\ContinuedFloat
	\begin{subtable}[h]{1\textwidth} 
		...
		\end{tabular}
		\caption{Accuracy and confusion matrix for the SVM with RFE using feature set three after five trials. Regarding the confusion matrix, the rows show the actual terrains and the columns show the predicted terrains.}
		\label{subt:svmexp}
	\end{subtable}
	\caption[Results of the SVM using feature set three with RFE]{Results of the SVM using feature set three with RFE after five trials. The results consist of: precision (a), recall (b), f-score (c), and accuracy and confusion matrix (d).}
	\label{svmexp}
\end{table}
\FloatBarrier
\newpage
...
\begin{table}[h]\ContinuedFloat
	\begin{subtable}[h]{1\textwidth} 
		...
		\end{tabular}
		\caption{Accuracy and confusion matrix for the neural network using feature set five after five trials. Regarding the confusion matrix, the rows show the actual terrains and the columns show the predicted terrains.}
		\label{nnset5}
	\end{subtable}
\caption[Results of the neural network using feature set five]{Results of the neural network on feature set five after five runs. The results consist of: precision (a), recall (b), f-score (c), and accuracy and confusion matrix (d).}
\label{tab:nn5}
\end{table}
\FloatBarrier
\newpage
...
\begin{table}[h]\ContinuedFloat
	\begin{subtable}[h]{1\textwidth} 
		...
		\end{tabular}
		\caption{Accuracy and confusion matrix for the decision tree using feature set one with RFLV after five trials. Regarding the confusion matrix, the rows show the actual terrains and the columns show the predicted terrains.}
		\label{dt1ee}
		\end{subtable}
	\caption[Results of the decision tree using feature set one with RFLV]{Results of decision tree using feature set one with RFLV after five trials. The results consist of: precision (a), recall (b), f-score (c), and accuracy and confusion matrix (d).}
\label{dt44}
\end{table}
\FloatBarrier
\newpage
...
\begin{table}[h]\ContinuedFloat
	...
	\end{tabular}
	\caption{Accuracy and confusion matrix for the decision tree using feature set one after five trials. Regarding the confusion matrix, the rows show the actual terrains and the columns show the predicted terrains.}
	\label{dt1e}
	\end{subtable}
	\caption[Results of the decision tree using feature set one]{Results of the decision tree on feature set one after five trials. The results consist of: precision (a), recall (b), f-score (c), and accuracy and confusion matrix (d).}
\label{dt1e222}
\end{table}
\FloatBarrier
\newpage
...
\begin{table}[h]\ContinuedFloat
	\begin{subtable}[h]{1\textwidth} 
		...
		\end{tabular}
		\caption{Accuracy and confusion matrix for the neural network using feature set one after five trials. Regarding confusion matrix, the row is the actual terrains and the columns is the predicted terrains.}
		\label{nn2}
	\end{subtable}
