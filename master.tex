...
\lstinputlisting[language=C++, caption={A simplified method to achieve a fixed length of data sequence},captionpos=b,label={ap:code1},breaklines=true]{code/data_seg.cpp}
%frame=single
