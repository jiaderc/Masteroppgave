...
\section{Optical force sensor}
The sensor used in this thesis is OptoForce (3D force sensor) \cite{Optoforce}. It has similar to Tar and Cserey \cite{6027100}. A construction of the sensor is shown on the figure \ref{fig:OptoforceBuild}. 
\begin{figure}[h]
	\centering
