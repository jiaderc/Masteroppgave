...
\begin{figure} [h]
	...
	\caption[Comparison between each feature on different terrains selected by RFE]{A comparison between each feature selected by RFE, for each terrain on feature set three.}
